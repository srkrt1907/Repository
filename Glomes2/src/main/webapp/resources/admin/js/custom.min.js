...
if (typeof NProgress != 'undefined') {
	...
	function init_flot_chart(){
		...
		for (var i = 0; i < 25; i++) {
		var deger = (00 + i) + ":00";
		  chart_plot_02_data.push( [deger, randNum() + i + i + 10]);
		}
		...
		function init_echarts() {
			...
			if ($('#mainb').length ){
				  ...
				  echartBar.setOption({
					...
					xAxis: [{
					  type: 'category',
					  data: ['8:00', '9:00', '10:00', '11:00', '12:00','1:00', '2:00', '3:00', '4:00', '5:00','6:00']
					}],
					yAxis: [{
					  type: 'value'
					}],
					series: [{
					  name: 'Mesaj Sayisi',
					  type: 'bar',
					  data: [2, 5, 7.0, 23, 25, 76, 135, 162, 32, 20.0, 6],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '???'
			...
			if ($('#mainb2').length ){
				  ...
				  echartBar.setOption({
					...
					series: [{
					  name: 'Mesaj Sayisi',
					  type: 'bar',
					  data: [5, 10, 7.0, 23, 25, 36, 25, 80, 45, 47, 40],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '???'
